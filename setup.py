...
rest_activation = 0.9 # fraction of restraints to be activated (Please note force constant also depends on frac_activation)
k_model1 = 1000.0 # force constant for model1 (here alpha, kb*gamma gamma=Eb/Ea)
