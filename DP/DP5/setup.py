...
rest_activation = 0.96 # fraction of restraints to be activated (Please note force constant also depends on frac_activation)
k_model1 = 1200.0 # force constant for alpha (kb*gamma gamma=Eb/Ea)
